...
#ifndef __ESP32C3_REGS_H
#define __ESP32C3_REGS_H
...
#define ESP_EFUSE_BASE             0x60008800u
...
#define ESP_APB_SARADC_BASE        0x60040000u
#define ESP_USB_SERIAL_JTAG_BASE   0x60043000u

#include "esp32c3_system_regs.h"
#include "esp32c3_watchdog_regs.h"
#include "esp32c3_interrupt_regs.h"
#include "esp32c3_gpio_regs.h"
#include "esp32c3_uart_regs.h"
#include "esp32c3_systimer_regs.h"
#include "esp32c3_usb_regs.h"
#include "esp32c3_adc_regs.h"
#include "esp32c3_i2c_regs.h"
#include "esp32c3_spi_regs.h"
#include "esp32c3_ledc_regs.h"

#endif // esp32c3_regs.h
